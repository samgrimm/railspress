  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Website" do
        expect {
          post :create, params: {website: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved website as @website" do
        post :create, params: {website: invalid_attributes}, session: valid_session
        expect(assigns(:website)).to be_a_new(Website)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested website" do
        website = Website.create! valid_attributes
        put :update, params: {id: website.to_param, website: new_attributes}, session: valid_session
        website.reload
      ...
      it "assigns the requested website as @website" do
        website = Website.create! valid_attributes
        put :update, params: {id: website.to_param, website: valid_attributes}, session: valid_session
        expect(assigns(:website)).to eq(website)
      end
    ...
    context "with invalid params" do
      it "assigns the website as @website" do
        website = Website.create! valid_attributes
        put :update, params: {id: website.to_param, website: invalid_attributes}, session: valid_session
        expect(assigns(:website)).to eq(website)
      end
